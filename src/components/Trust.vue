            ...
            <div class="flex flex-col md:flex-row md:items-stretch items-center gap-12 md:gap-16 lg:gap-24">
                ...
                <div class="w-full md:w-1/2 relative flex" ref="imageRef">
                    <div
                        ...
                        <img :src="busTerminalImg" alt="Bus terminal" class="w-full h-full object-cover dark:opacity-80 transition-opacity duration-300"
                            loading="lazy" />
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-2">
                                <span class="text-[20px] sm:text-[24px] font-bold text-primary dark:text-dark-text">10x</span>
                                <div
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-[16px] text-text-secondary dark:text-dark-muted leading-[1.6]"><strong
                                    class="text-primary dark:text-dark-text font-bold">No cash needed:</strong> Pay your fare instantly from your phone. No more arguing over exact change.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <CheckCircle2 :size="20" class="text-accent dark:text-dark-muted shrink-0 mt-1" />
                            <span class="text-[16px] text-text-secondary dark:text-dark-muted leading-[1.6]"><strong
                                    class="text-primary dark:text-dark-text font-bold">Instant confirmation:</strong> Drivers see the payment immediately. No waiting for bank alerts to drop.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <CheckCircle2 :size="20" class="text-accent dark:text-dark-muted shrink-0 mt-1" />
                            <span class="text-[16px] text-text-secondary dark:text-dark-muted leading-[1.6]"><strong
                                    class="text-primary dark:text-dark-text font-bold">Works with any bank:</strong> You don't need a special wallet. Pay using your existing bank app or USSD.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <CheckCircle2 :size="20" class="text-accent dark:text-dark-muted shrink-0 mt-1" />
                            <span class="text-[16px] text-text-secondary dark:text-dark-muted leading-[1.6]"><strong class="text-primary dark:text-dark-text font-bold">Smooth boarding:</strong> Keep the line moving. Scan, pay, and take your seat in seconds.</span>
                        </li>
                    </ul>
                </div>
            </div>
...
<script setup>
import busTerminalImg from '@/assets/images/busterminal.png'
