<template>
  <section id="process"
    class="bg-primary dark:bg-dark-base py-10 sm:py-16 md:py-24 transition-colors duration-300 border-t border-gray-200/60 dark:border-dark-border/40"
    ref="sectionRef">
    <div class="max-w-300 mx-auto px-3 sm:px-5 md:px-8 text-center">
      <div class="mb-10 sm:mb-12 md:mb-16">
        <p
          class="mb-3 text-sm font-semibold uppercase tracking-[0.35em] text-text-secondary dark:text-dark-text-secondary">
          Simple Process
        </p>
      ...
      <div class="relative">
        <div class="absolute top-5.5 left-[16.66%] right-[16.66%] h-0.5 hidden md:block z-0" aria-hidden="true">
